...
$(document).on('click', '#save-content', function(){
	$.ajax({
		url: "http://entlaqa.net/eventribe/event/content_submit",
		type: "POST",
		data: form_data,
		async: false,
		cache: false,
